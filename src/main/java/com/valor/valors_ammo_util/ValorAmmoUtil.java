...
public class ValorAmmoUtil extends JavaPlugin {
    ...
    protected void setup() {
        this.getCodecRegistry(Interaction.CODEC).register("AmmoModifyInventory", ValorUseAmmo.class, ValorUseAmmo.CODEC);
        ...
        this.getCodecRegistry(Interaction.CODEC).register("AmmoDespawn", AmmoRemove.class, AmmoRemove.CODEC);
